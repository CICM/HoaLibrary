...
#define Cicm_Signal_Vector__Matrix_Double_Copy(vectorSource, matrixDest, row_number, size) vDSP_mmovD(vectorSource, matrixDest, size, 1, size, size)

/* Vector and Matrix Product */
#define Cicm_Matrix_Vector_Float_Product(matrix, vectorSource, vectorDest, number_of_rows, column_size) cblas_sgemv(CblasRowMajor, CblasNoTrans, number_of_rows, column_size, 1.f, &matrix[0][0], number_of_rows, vectorSource, 1, 0.f, vectorDest, 1)
#define Cicm_Matrix_Vector_Double_Product(matrix, vectorSource, vectorDest, number_of_rows, column_size) cblas_dgemv(CblasRowMajor, CblasNoTrans, number_of_rows, column_size, 1., &matrix[0][0], number_of_rows, vectorSource, 1, 0.0, vectorDest, 1)
