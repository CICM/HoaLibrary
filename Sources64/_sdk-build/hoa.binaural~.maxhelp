...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 274.0, 405.0, 56.0, 19.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "float" ],
									"patching_rect" : [ 79.0, 393.0, 56.0, 19.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 434.75, 198.0, 32.5, 19.0 ],
									"text" : "*~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "float" ],
									"patching_rect" : [ 502.0, 222.0, 56.0, 19.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 370.0, 173.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 363.0, 198.0, 59.0, 19.0 ],
									"text" : "hoa.pi~ 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 486.0, 252.0, 88.0, 17.0 ],
									"text" : "pinnasize large"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 493.0, 305.0, 90.0, 17.0 ],
									"text" : "pinnasize small"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 174.5, 439.0, 52.0, 17.0 ],
									"text" : "set 9 10"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "hoa.binaural~ virtualizes ambisonic soundfield for two headspeakers. It uses hrtf to perform FIR filtering on the incoming signal. Hrtf are extracted from the \"sipic hrtf database\". hoa.binaural~ works up to the order 35\n",
									"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 434.75, 222.0, 49.0, 19.0 ],
									"text" : "hoa.pi~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 434.75, 168.0, 72.0, 19.0 ],
									"text" : "phasor~ 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 10.5, 280.0, 348.0, 19.0 ],
									"text" : "hoa.encoder~ 7"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 7.0, 476.0, 376.0, 19.0 ],
									"text" : "hoa.dac~ 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 434.75, 137.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 7.0, 168.0, 218.0, 87.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 7.0, 345.0, 372.5, 19.0 ],
									"saved_object_attributes" : 									{
										"pinnasize" : ""
									}
,
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 184.0, 465.0, 16.5, 465.0 ],
									"source" : [ "obj-5", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 370.0, 368.0, 427.0, 368.0 ],
									"source" : [ "obj-8", 1 ]
								}
...
,
					"patching_rect" : [ 28.75, 15.0, 58.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 11.595187,
