{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "count~ is set to start counting when the DSP turns on - it does not need an input in its left inlet.",
					"linecount" : 2,
					"presentation_rect" : [ 0.0, 0.0, 0.0, 0.0 ],
					"numinlets" : 1,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
					"background" : 0,
					"patching_rect" : [ 527.0, 190.0, 274.0, 33.0 ],
					"numoutlets" : 0,
					"presentation" : 0,
					"id" : "obj-42",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "instead of count~ we could also use the (rightmost) sync outlet of our fftin~ to provide us with the bin number.  both techniques work equally well..",
					"linecount" : 5,
					"presentation_rect" : [ 0.0, 0.0, 0.0, 0.0 ],
					"numinlets" : 1,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
					"background" : 0,
					"patching_rect" : [ 630.0, 112.0, 183.0, 73.0 ],
					"numoutlets" : 0,
					"presentation" : 0,
					"id" : "obj-32",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"background" : 0,
					"patching_rect" : [ 530.0, 159.0, 97.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"background" : 0,
					"patching_rect" : [ 477.0, 83.0, 32.0, 20.0 ],
					"color" : [ 0.8, 0.84, 0.71, 1.0 ],
					"numoutlets" : 1,
					"presentation" : 0,
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"background" : 0,
					"patching_rect" : [ 477.0, 40.0, 29.0, 20.0 ],
					"color" : [ 0.8, 0.84, 0.71, 1.0 ],
					"numoutlets" : 1,
					"presentation" : 0,
					"id" : "obj-4",
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"background" : 0,
					"patching_rect" : [ 477.0, 202.0, 32.5, 20.0 ],
					"color" : [ 0.8, 0.84, 0.71, 1.0 ],
					"numoutlets" : 1,
					"presentation" : 0,
					"id" : "obj-10",
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
					"background" : 0,
					"patching_rect" : [ 508.0, 39.0, 156.0, 20.0 ],
					"numoutlets" : 0,
					"presentation" : 0,
					"id" : "obj-27",
					"fontname" : "Arial",
