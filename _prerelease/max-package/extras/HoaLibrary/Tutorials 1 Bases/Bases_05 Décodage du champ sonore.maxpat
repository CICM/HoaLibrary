...
,
					"patching_rect" : [ 318.0, 394.0, 69.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "En ambisonie, le décodage est l'opération qui consiste à synthetiser les signaux attribués aux haut-parleurs. Comme dans toute les techniques de spatialisation, cette opération comporte des avantages et certaines restrictions.\n\n1 - L'ambisonie permet de synthetiser plusieurs champs sonores et de les restituer via une seule opération de  décodage, offrant ainsi l'avantage de pouvoir encoder une multitude de sources tout en utilisant qu'un seul décodage et ainsi diminuer l'utilisation CPU.\n\n2 - Séparer ces deux processus, permet non seulement de réaliser de nombreuse opérations dans le domaine des harmoniques circualires mais aussi de pouvoir enregistrer le champ sonore dans le domaine des harmoniques circulaires pour par la suite le restituer sur différentes configurations de haut-parleurs.\n\n3 - L'ambisonie offre un rendu homogène du champ sonore. Contrairement à d'autres techniques de spatialisation où la résolution angulaire des sources sonores varie en fonction de la direction de la source, l'ambisonie offre une résolution angulaire constante sur l'ensemble du cercle quite à diminuer la qualité de resitution.\n\n4 - Le système de restitution en ambisonie est restreint par l'ordre de décomposition et par les principes acoustiques sous-jacents à ces techniques. Le nombre de haut-parleurs doit être inférieur ou égal au nombre d'harmoniques. Ainsi le nombre minimum de haut-parleurs est de 3 pour un ordre de décomposition 1. De plus les haut-parleurs doivent être placés sur un cercle et à distance égale les uns des autres. Notons néanmoins que toutes ces restrictions peuvent être contournées au détriment de la qualité de restitution du champ sonore. Ainsi, il est possible de projeter le champ sonore sur des sytèmes allant de la stéréophonie à une infinité de haut-parleurs en passant par toutes les configuartions irrégulières telles que le 5.1. (voir l'objet hoa.decoder~)\n\n5 - En ambisonie, l'auditeur doit être idéalement placé au cente du cercle sinon l'image du champ sonore est déformée. Notons néanmoins que l'utilisation des optimisations maxRe et inPhase (voir l'objet hoa.optim~) permettent de pallier cette contrainte au détriment de la résolution angulaire des sources sonores. ",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 78.0, 646.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 711.099976, 490.5, 76.0, 19.0 ],
					"text" : "loadmess 16"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 688.599976, 484.0, 95.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 711.099976, 578.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 711.099976, 550.0, 92.0, 19.0 ],
					"text" : "expr ($i1 - 1) / 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 688.599976, 611.0, 114.5, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 711.099976, 523.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.099976, 490.5, 70.0, 19.0 ],
					"text" : "loadmess 7"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 581.099976, 578.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.099976, 550.0, 89.0, 19.0 ],
					"text" : "expr $i1 * 2 + 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 558.599976, 611.0, 103.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 558.599976, 611.0, 102.0, 32.0 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 558.599976, 484.0, 102.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 581.099976, 523.0, 50.0, 19.0 ]
				}
...
,
					"patching_rect" : [ 33.0, 394.0, 69.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
