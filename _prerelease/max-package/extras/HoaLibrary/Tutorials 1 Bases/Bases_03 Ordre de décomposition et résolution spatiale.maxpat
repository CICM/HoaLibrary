...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 602.0, 325.0, 70.0, 19.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 233.5, 301.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 68.0, 812.0, 123.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.5, 270.0, 70.0, 19.0 ],
					"text" : "loadmess 7"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "Hoa", "Tutoriel", "Bases", 3, ":", "Ordre", "de", "dé́composition", "et", "résolution", "spatiale", "@obj-desc", "" ],
					"id" : "obj-29",
					"maxclass" : "bpatcher",
...
,
					"patching_rect" : [ 252.5, 330.0, 69.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 252.5, 301.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 658.0, 366.0, 123.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 602.0, 379.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 396.0, 411.0, 225.0, 19.0 ],
					"text" : "hoa.wider~ 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 396.0, 312.0, 42.0, 19.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 396.0, 360.0, 211.266663, 19.0 ],
					"text" : "hoa.encoder~ 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 7,
					"patching_rect" : [ 396.0, 464.0, 225.0, 225.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.5, 263.0, 95.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.0, 263.0, 322.250031, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 25.0, 366.0, 225.0, 19.0 ],
					"text" : "matrix~ 1 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 300.5, 644.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 263.0, 192.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 25.0, 312.0, 42.0, 19.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 25.0, 403.0, 225.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 204.0, 809.650024, 32.0 ],
					"text" : "Cet exemple permet de varier l'ordre de décompostion en annulant les contributions des harmoniques circulaires supérieures à un certain ordre, ce qui engendre une diminution de la résolution spatiale du champ sonore.",
					"textcolor" : [ 0.317518, 0.317518, 0.317518, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 7,
					"patching_rect" : [ 25.0, 464.0, 225.0, 225.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.5, 263.0, 93.0, 32.0 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 262.0, 356.0, 35.0, 356.0, 35.0, 361.0, 34.5, 361.0 ],
					"source" : [ "obj-32", 0 ]
				}
