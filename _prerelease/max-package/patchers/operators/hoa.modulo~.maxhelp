...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 110.9375, 327.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.4375, 300.5, 326.0, 20.0 ],
					"text" : "output modulo of two signals  by naming each one before",
					"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "signal and float in post mode, independent operations",
					"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.2d.process~ 1 hoa.%~ post 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 171.0, 261.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 93.0, 261.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 15.0, 212.0, 175.0, 22.0 ],
					"text" : "hoa.2d.process~ 1 hoa.%~ no 3"
				}
