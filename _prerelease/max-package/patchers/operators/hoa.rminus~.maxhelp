...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.4375, 300.5, 318.0, 20.0 ],
					"text" : "substract two signals together by naming each one before",
					"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.2d.process~ 1 hoa.!-~ post 2"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.2d.process~ 1 hoa.!-~ no 10"
				}
