...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 455.0, 89.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 455.0, 120.0, 42.0, 20.0 ],
					"text" : "sig~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : 0.0,
					"patching_rect" : [ 63.900002, 375.0, 170.199997, 170.199997 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.0, 165.0, 48.0, 20.0 ],
					"text" : "*~ 180."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.0, 195.0, 46.0, 20.0 ],
					"text" : "/~ 360."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 300.0, 195.0, 55.0, 20.0 ],
					"text" : "hoa.pi 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.75, 465.0, 32.5, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 435.0, 72.0, 18.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 6,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 545.200012, 208.0, 20.0 ],
					"text" : "hoa.dac~ 1:6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.0, 225.0, 51.0, 20.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 255.0, 208.0, 20.0 ],
					"text" : "hoa.encoder~ 7"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 344.25, 495.0, 243.5, 495.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 309.5, 495.0, 243.5, 495.0 ],
					"source" : [ "obj-8", 0 ]
				}
