...
,
		"rect" : [ 136.0, 198.0, 966.0, 579.0 ],
		"bglocked" : 0,
		"defrect" : [ 136.0, 198.0, 966.0, 579.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 840.0, 165.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 720.0, 75.0, 33.0, 20.0 ],
					"text" : "* -1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.0, 105.0, 59.0, 20.0 ],
					"text" : "clip -0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 675.0, 180.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 330.0, 30.0, 43.0, 20.0 ],
					"text" : "abs 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 720.0, 45.0, 172.0, 20.0 ],
					"text" : "if $f1 < 0. then $f1 else out2 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.0, 135.0, 125.0, 20.0 ],
					"text" : "scale 1. 0. 0.5 0.9375"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 17,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 750.0, 225.0, 235.0, 20.0 ],
...
,
						"rect" : [ 510.0, 360.0, 242.0, 106.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 510.0, 360.0, 242.0, 106.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 510.0, 360.0, 242.0, 106.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 17,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 510.0, 225.0, 235.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 510.0, 315.0, 235.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 478.0, 90.0, 46.0, 20.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 45.0, 47.0, 18.0 ],
					"text" : "open 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 330.0, 0.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 17,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 255.0, 390.0, 235.0, 20.0 ],
...
,
						"rect" : [ 255.0, 240.0, 242.0, 106.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 255.0, 240.0, 242.0, 106.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 255.0, 240.0, 242.0, 106.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 510.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 510.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 615.0, 15.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 135.0, 126.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 255.0, 90.0, 214.0, 20.0 ],
...
,
					"patching_rect" : [ 495.0, 15.0, 59.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 495.0, 45.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 255.0, 180.0, 221.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 255.0, 60.0, 42.0, 20.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 255.0, 120.0, 242.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 14 ],
					"hidden" : 0,
					"midpoints" : [ 519.5, 165.0, 467.0, 165.0 ],
					"source" : [ "obj-3", 0 ]
				}
