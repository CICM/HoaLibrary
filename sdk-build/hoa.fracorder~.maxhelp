...
,
		"rect" : [ 495.0, 44.0, 879.0, 590.0 ],
		"bglocked" : 0,
		"defrect" : [ 495.0, 44.0, 879.0, 590.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 225.0, 215.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 7,
					"patching_rect" : [ 30.0, 281.0, 243.0, 243.0 ],
					"textcolor" : [  ]
				}
...
,
					"patching_rect" : [ 600.0, 60.0, 51.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 600.0, 90.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 555.0, 241.5, 20.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 285.0, 176.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 285.0, 206.0, 45.0, 20.0 ],
					"text" : "sig~ 0."
				}
...
,
						"rect" : [ 270.0, 120.0, 303.0, 49.0 ],
						"bgcolor" : [ 0.537255, 0.537255, 0.537255, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 270.0, 120.0, 303.0, 49.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 270.0, 120.0, 303.0, 49.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 251.0, 243.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 465.0, 72.0, 18.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 525.0, 243.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 294.5, 248.0, 263.5, 248.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 324.5, 552.0, 262.0, 552.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 294.5, 197.0, 294.5, 197.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 263.5, 272.0, 263.5, 272.0 ],
					"source" : [ "obj-35", 14 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 247.5, 272.0, 247.5, 272.0 ],
					"source" : [ "obj-35", 13 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 231.5, 272.0, 231.5, 272.0 ],
					"source" : [ "obj-35", 12 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 215.5, 272.0, 215.5, 272.0 ],
					"source" : [ "obj-35", 11 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 199.5, 272.0, 199.5, 272.0 ],
					"source" : [ "obj-35", 10 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 9 ],
					"hidden" : 1,
					"midpoints" : [ 183.5, 272.0, 183.5, 272.0 ],
					"source" : [ "obj-35", 9 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 8 ],
					"hidden" : 1,
					"midpoints" : [ 167.5, 272.0, 167.5, 272.0 ],
					"source" : [ "obj-35", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 6 ],
					"hidden" : 1,
					"midpoints" : [ 135.5, 272.0, 135.5, 272.0 ],
					"source" : [ "obj-35", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 5 ],
					"hidden" : 1,
					"midpoints" : [ 119.5, 272.0, 119.5, 272.0 ],
					"source" : [ "obj-35", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 4 ],
					"hidden" : 1,
					"midpoints" : [ 103.5, 272.0, 103.5, 272.0 ],
					"source" : [ "obj-35", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 3 ],
					"hidden" : 1,
					"midpoints" : [ 87.5, 272.0, 87.5, 272.0 ],
					"source" : [ "obj-35", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 2 ],
					"hidden" : 1,
					"midpoints" : [ 71.5, 272.0, 71.5, 272.0 ],
					"source" : [ "obj-35", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 1 ],
					"hidden" : 1,
					"midpoints" : [ 55.5, 272.0, 55.5, 272.0 ],
					"source" : [ "obj-35", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 1,
					"midpoints" : [ 39.5, 272.0, 39.5, 272.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 279.5, 171.0, 279.0, 171.0, 279.0, 210.0, 39.5, 210.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"hidden" : 0,
					"midpoints" : [ 609.5, 81.0, 609.5, 81.0 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 15 ],
					"hidden" : 0,
					"midpoints" : [ 309.5, 483.0, 309.0, 483.0, 309.0, 552.0, 262.0, 552.0 ],
					"source" : [ "obj-7", 0 ]
				}
