...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 420.0, 375.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 426.0, 153.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.0, 180.0, 71.0, 20.0 ],
					"text" : "pack 0. 100"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 426.0, 210.0, 36.0, 20.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 7,
					"patching_rect" : [ 43.18367, 300.0, 262.017487, 262.017487 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 43.18367, 255.0, 262.017487, 20.0 ],
					"text" : "hoa.wider~ 7"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 168.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 43.18367, 210.0, 245.81633, 20.0 ],
					"text" : "hoa.encoder~ 7"
				}
...
,
					"patching_rect" : [ 43.18367, 101.5, 218.0, 87.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 435.5, 240.0, 295.701172, 240.0 ],
					"source" : [ "obj-28", 0 ]
				}
