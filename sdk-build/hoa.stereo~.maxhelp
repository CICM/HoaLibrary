...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 750.0, 210.0, 43.0, 20.0 ],
					"text" : "+~ 45."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 374.0, 140.0, 150.0, 33.0 ],
					"text" : "Keep the ponctual source between - 30° and 30°"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 483.0, 380.0, 12.0, 90.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 738.0, 380.0, 12.0, 90.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 495.0, 304.0, 20.0 ],
					"text" : "hoa.dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 791.0, 180.0, 150.0, 33.0 ],
					"text" : "Keep the ponctual source between - 15° and 105°"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 750.0, 180.0, 41.0, 20.0 ],
					"text" : "*~ 60."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 750.0, 146.5, 63.0, 20.0 ],
					"text" : "cycle~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 750.0, 240.0, 46.0, 20.0 ],
					"text" : "/~ 360."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 797.75, 240.0, 55.0, 20.0 ],
					"text" : "hoa.pi 2."
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 750.0, 113.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 750.0, 90.0, 79.0, 20.0 ],
					"text" : "loadmess 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 750.0, 270.0, 66.75, 20.0 ],
					"text" : "*~"
				}
...
,
					"patching_rect" : [ 465.0, 180.0, 218.0, 87.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 465.0, 300.0, 304.0, 20.0 ],
					"text" : "hoa.encoder~ 15"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 465.0, 340.0, 304.0, 20.0 ],
					"text" : "hoa.stereo~ 15 120 45"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 60.0, 330.0, 12.0, 90.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 315.0, 330.0, 12.0, 90.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 330.0, 153.0, 41.0, 20.0 ],
					"text" : "*~ 30."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 330.0, 120.0, 63.0, 20.0 ],
					"text" : "cycle~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 330.0, 180.0, 46.0, 20.0 ],
					"text" : "/~ 360."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 377.75, 173.0, 55.0, 20.0 ],
					"text" : "hoa.pi 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.0, 397.0, 32.5, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 366.0, 72.0, 18.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 56.0, 79.0, 20.0 ],
					"text" : "loadmess 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 450.0, 304.0, 20.0 ],
					"text" : "hoa.dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 600.0, 69.0, 105.0, 20.0 ],
					"text" : "hoa.connect 15 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 330.0, 210.0, 66.75, 20.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 31,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 45.0, 240.0, 304.0, 20.0 ],
					"text" : "hoa.encoder~ 15"
				}
...
,
					"patching_rect" : [ 45.0, 113.0, 218.0, 87.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 45.0, 280.0, 304.0, 20.0 ],
					"text" : "hoa.stereo~ 15"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.75, 6.0, 316.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "An ambisonic decoder for a stereophonic system",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 56.0, 557.0, 46.0 ],
					"text" : "hoa.stereo~ decodes an ambisonic soundfield for a stereophonic system.  First argument is the order of the ambisonic soundfield, second argument is the total angle between the two loudspeakers (default 60°) and third arguments is the angle of the central axe (default 0°). ",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 383.5, 435.0, 339.5, 435.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 369.5, 435.0, 339.5, 435.0 ],
					"source" : [ "obj-8", 0 ]
				}
