...
,
		"rect" : [ 309.0, 66.0, 803.0, 623.0 ],
		"bglocked" : 0,
		"defrect" : [ 309.0, 66.0, 803.0, 623.0 ],
...
,
						"rect" : [ 420.0, 465.0, 242.0, 106.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 420.0, 465.0, 242.0, 106.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 420.0, 465.0, 242.0, 106.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 585.0, 241.5, 20.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 420.0, 435.0, 242.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 420.0, 390.0, 208.0, 20.0 ],
					"text" : "hoa.encoderOLD~ 7 split"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 495.0, 32.5, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 225.0, 157.0, 60.0 ],
					"text" : "Optimizations can be used on the harmonics. Please see Jérome Daniel's thesis p. 312."
				}
...
,
						"rect" : [ 45.0, 420.0, 242.0, 106.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 45.0, 420.0, 242.0, 106.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 45.0, 420.0, 242.0, 106.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 540.0, 241.5, 20.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 255.0, 70.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 315.0, 85.0, 20.0 ],
					"text" : "prepend optim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 390.0, 285.0, 100.0, 20.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.0, 105.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 315.0, 135.0, 71.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 45.0, 300.0, 242.0, 20.0 ],
					"text" : "hoa.encoder~ 7"
				}
...
,
						"rect" : [ 45.0, 106.0, 218.0, 87.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 45.0, 106.0, 218.0, 87.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 45.0, 106.0, 218.0, 87.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 45.0, 390.0, 242.5, 20.0 ],
					"text" : "hoa.decoder~ 7 16"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 354.5, 537.0, 277.0, 537.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 14 ],
					"hidden" : 0,
					"midpoints" : [ 399.5, 375.0, 278.0, 375.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 0 ],
					"hidden" : 0,
					"midpoints" : [ 440.0, 306.0, 399.0, 306.0, 399.0, 312.0, 399.5, 312.0 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 15 ],
					"hidden" : 0,
					"midpoints" : [ 339.5, 537.0, 277.0, 537.0 ],
					"source" : [ "obj-8", 0 ]
				}
