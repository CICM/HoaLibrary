...
,
		"rect" : [ 379.0, 82.0, 805.0, 712.0 ],
		"bglocked" : 0,
		"defrect" : [ 379.0, 82.0, 805.0, 712.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 675.0, 241.5, 20.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
,
						"rect" : [ 15.0, 555.0, 242.0, 106.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 15.0, 555.0, 242.0, 106.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 15.0, 555.0, 242.0, 106.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 210.0, 79.0, 20.0 ],
					"text" : "loadmess 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 615.0, 32.5, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 585.0, 72.0, 18.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 135.0, 150.0, 33.0 ],
					"text" : "Initial azimuth of the source."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 15.0, 510.0, 242.5, 20.0 ],
...
,
						"rect" : [ 15.0, 390.0, 226.0, 105.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 15.0, 390.0, 226.0, 105.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 15.0, 390.0, 226.0, 105.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 285.0, 270.0, 72.0, 20.0 ],
					"text" : "phasor~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 525.0, 90.0, 99.0, 20.0 ],
...
,
						"rect" : [ 15.0, 240.0, 226.0, 105.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 15.0, 240.0, 226.0, 105.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 15.0, 240.0, 226.0, 105.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 15.0, 210.0, 226.0, 20.0 ],
					"text" : "hoa.encoder~ 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 15.0, 360.0, 240.5, 20.0 ],
					"text" : "hoa.rotate~ 7"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.rotate~ by Julien Colafrancesco, Pierre Guillot & Eliott Paris © 2012 CICM / Universite Paris 8"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "An ambisonic soundfield rotation external",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 56.0, 495.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 264.5, 195.0, 231.5, 195.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 279.5, 672.0, 247.0, 672.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 15 ],
					"hidden" : 0,
					"midpoints" : [ 309.5, 672.0, 247.0, 672.0 ],
					"source" : [ "obj-20", 0 ]
				}
