...
#ifndef MAX_LOUDSPEAKERS
#define MAX_LOUDSPEAKERS JucePlugin_MaxNumOutputChannels
#endif
#ifndef MIN_LOUDSPEAKERS
#define MIN_LOUDSPEAKERS 1
#endif
#ifndef DEF_LOUDSPEAKERS
#define DEF_LOUDSPEAKERS 8
#endif
#ifndef MAX_SOURCES
#define MAX_SOURCES JucePlugin_MaxNumInputChannels
#endif
#ifndef MIN_SOURCES
#define MIN_SOURCES 1
#endif
#ifndef DEF_SOURCES
#define DEF_SOURCES 1
#endif

#define CoordsParamBegin 2
...
public:
    ...
    template<typename Type> static Type degtorad(Type degree)
    {
        return degree / (Type)(360. / CICM_2PI);
    }
