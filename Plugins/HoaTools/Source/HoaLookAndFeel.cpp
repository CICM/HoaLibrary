...
//==============================================================================
void HoaLookAndFeel::drawButtonBackground (Graphics& g,
                                                 Button& button,
...
void HoaLookAndFeel::drawTickBox (Graphics& g,
                                        Component& /*component*/,
...
void HoaLookAndFeel::drawToggleButton (Graphics& g,
                                             ToggleButton& button,
                                             bool isMouseOverButton,
                                             bool isButtonDown)
{
...
void HoaLookAndFeel::drawScrollbar (Graphics& g,
                                          ScrollBar& bar,
                                          int x, int y,
                                          int width, int height,
                                          bool isScrollbarVertical,
...
ImageEffectFilter* HoaLookAndFeel::getScrollbarEffect()
{
...
//==============================================================================
void HoaLookAndFeel::drawPopupMenuBackground (Graphics& g, int width, int height)
{
...
//==============================================================================
void HoaLookAndFeel::drawTextEditorOutline (Graphics& g, int width, int height, TextEditor& textEditor)
{
...
Font HoaLookAndFeel::getComboBoxFont (ComboBox& box)
{
...
void HoaLookAndFeel::drawLinearSlider (Graphics& g,
                                             int x, int y,
                                             int w, int h,
                                             float sliderPos,
                                             float minSliderPos,
...
//==============================================================================
void HoaLookAndFeel::drawCornerResizer (Graphics& g,
                                              int w, int h,
                                              bool isMouseOver,
...
//==============================================================================
Button* HoaLookAndFeel::createDocumentWindowButton (int buttonType)
{
    Path shape;
...
void HoaLookAndFeel::positionDocumentWindowButtons (DocumentWindow&,
                                                          int titleBarX,
                                                          int titleBarY,
                                                          int titleBarW,
                                                          int titleBarH,
