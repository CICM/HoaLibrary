...
t_hoa_err hoa_getinfos(t_hoa_optim_3D* x, t_hoa_boxinfos* boxinfos);
...
void *hoa_optim_3D_new(t_symbol *s, long argc, t_atom *argv)
{
    t_hoa_optim_3D *x = NULL;
	int	order = 1;
    
    x = (t_hoa_optim_3D *)eobj_new(hoa_optim_3D_class);
	if (x)
	{
		...
		x->f_optim = new Optim(order, Hoa3D::Optim::InPhase);
