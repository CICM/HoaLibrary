...
void hoa_decoder_3D_perform64_regular(t_hoa_decoder_3D *x, t_object *dsp64, float **ins, long numins, float **outs, long numouts, long sampleframes, long flags, void *userparam);
void hoa_decoder_3D_perform64_irregular(t_hoa_decoder_3D *x, t_object *dsp64, float **ins, long numins, float **outs, long numouts, long sampleframes, long flags, void *userparam);
void hoa_decoder_3D_perform64_binaural(t_hoa_decoder_3D *x, t_object *dsp64, float **ins, long numins, float **outs, long numouts, long sampleframes, long flags, void *userparam);
...
void hoa_decoder_3D_deprecated(t_hoa_decoder_3D* x, t_symbol *s, long ac, t_atom* av);
...
extern "C" void setup_hoa0x2e2d0x2edecoder_tilde(void)
{
    ...
    c = eclass_new("hoa.2d.decoder~", (method)hoa_decoder_3D_new, (method)hoa_decoder_3D_free, (short)sizeof(t_hoa_decoder_3D), 0L, A_GIMME, 0);
    class_addcreator((t_newmethod)hoa_decoder_3D_new, gensym("hoa.decoder~"), A_GIMME, 0);
    
	eclass_dspinit(c);
    hoa_initclass(c, (method)hoa_getinfos);
    eclass_addmethod(c, (method)hoa_decoder_3D_dsp,           "dsp",          A_CANT,  0);
    eclass_addmethod(c, (method)hoa_decoder_3D_deprecated,    "pinnae",       A_GIMME, 0);
    eclass_addmethod(c, (method)hoa_decoder_3D_deprecated,    "restitution",  A_GIMME, 0);
    
    CLASS_ATTR_DOUBLE_VARSIZE	(c, "angles",0, t_hoa_decoder_3D, f_angles_of_channels, f_number_of_channels, MAX_CHANNELS);
	CLASS_ATTR_ACCESSORS		(c, "angles", NULL, angles_set);
	CLASS_ATTR_ORDER			(c, "angles", 0, "2");
	CLASS_ATTR_LABEL			(c, "angles", 0, "Angles of Loudspeakers");
    
    CLASS_ATTR_DOUBLE           (c, "offset", 0, t_hoa_decoder_3D, f_offset);
...
void *hoa_decoder_3D_new(t_symbol *s, long argc, t_atom *argv)
{
    ...
    if (x)
	{
        ...
        hoa_decoder_3D_deprecated(x, NULL, argc, argv);
...
void hoa_decoder_3D_dsp(t_hoa_decoder_3D *x, t_object *dsp64, short *count, double samplerate, long maxvectorsize, long flags)
{
    ...
    if(x->f_decoder->getDecodingMode() == Hoa2D::DecoderMulti::Regular)
        ...
        object_method(dsp64, gensym("dsp_add64"), x, (method)hoa_decoder_3D_perform64_irregular, 0, NULL);
