...
process(sig1, sig2, sig3, sig4, sig5, sig6, sig7, sig8) = map(3, sig1, r1, a1), map(3, sig2, r2, a2), map(3, sig3, r3, a3), map(3, sig4, r4, a4), map(3, sig5, r3, a3), map(3, sig6, r3, a3), map(3, sig7, r3, a3), map(3, sig8, r3, a3) :> optimInPhase(3) : decoder(3, 8);
