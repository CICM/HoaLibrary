...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 15.0, 217.0, 38.0, 20.0 ],
					"text" : "*~ 11"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 70.450012, 139.0, 56.0, 20.0 ],
					"text" : "sig~ 165"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 125.900024, 139.0, 53.0, 20.0 ],
					"text" : "sig~ 0.7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 116.900024, 15.0, 62.0, 20.0 ],
					"text" : "cycle~ 80"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 15.0, 63.0, 32.5, 20.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 15.0, 28.0, 56.0, 20.0 ],
					"text" : "saw~ 15"
				}
...
,
					"patching_rect" : [ 15.0, 183.0, 129.900024, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 247.25, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 126.400024, 60.0, 38.0, 60.0 ],
					"source" : [ "obj-28", 0 ]
				}
