...
,
		"rect" : [ 475.0, 110.0, 904.0, 645.0 ],
		"bglocked" : 0,
		"defrect" : [ 475.0, 110.0, 904.0, 645.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 330.0, 71.0, 18.0 ],
					"text" : "optim basic"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 360.0, 87.0, 18.0 ],
					"text" : "optim inPhase"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 745.0, 196.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 750.0, 150.0, 124.0, 20.0 ],
					"text" : "route /wii/1/balance/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 570.0, 465.0, 23.0, 20.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 435.0, 66.0, 20.0 ],
					"text" : "r switchWii"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 428.0, 189.0, 0.0, 0.0 ]
				}
...
,
					"patching_rect" : [ 465.0, 45.0, 51.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 75.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 525.0, 330.0, 62.0, 20.0 ],
					"text" : "-~ 1.5707"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 555.0, 270.0, 48.0, 20.0 ],
					"text" : "-~ 0.49"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 495.0, 270.0, 42.0, 20.0 ],
					"text" : "-~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 495.0, 300.0, 60.0, 20.0 ],
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 195.0, 41.0, 18.0 ],
					"text" : "$1 50"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 555.0, 225.0, 50.0, 20.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 195.0, 41.0, 18.0 ],
					"text" : "$1 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 555.0, 241.5, 20.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 150.0, 315.0, 242.0, 20.0 ],
					"text" : "hoa.encoder~ 7"
				}
...
,
						"rect" : [ 150.0, 121.0, 218.0, 87.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 150.0, 121.0, 218.0, 87.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 150.0, 121.0, 218.0, 87.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 150.0, 405.0, 242.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 495.0, 150.0, 136.0, 34.0 ],
					"text" : "route /wii/1/balance/5 /wii/1/balance/6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.0, 120.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 480.0, 72.0, 18.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 525.0, 50.0, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 474.5, 66.0, 474.5, 66.0 ],
					"source" : [ "obj-46", 0 ]
				}
