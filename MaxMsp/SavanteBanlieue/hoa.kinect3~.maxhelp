...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 640.0, 32.5, 17.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.0, 571.0, 72.0, 17.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 835.0, 258.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 766.0, 230.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 451.25, 603.0, 221.5, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 14.0, 379.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 544.0, 235.0, 50.0, 20.0 ],
					"presentation_rect" : [ 547.0, 236.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, 262.0, 71.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 544.0, 292.0, 36.0, 20.0 ],
					"presentation_rect" : [ 547.0, 293.0, 0.0, 0.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 631.0, 325.0, 42.0, 19.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1078.0, 178.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1078.0, 205.0, 71.0, 20.0 ],
					"text" : "pack 0. 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 1078.0, 235.0, 36.0, 20.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 144.0, 100.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 345.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 270.0, 150.0, 19.0 ],
					"text" : "bats in cave"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 225.0, 150.0, 19.0 ],
					"text" : "amorphous"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 627.0, 250.0, 50.0, 17.0 ],
					"text" : "off"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 654.0, 105.0, 94.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 429.0, 105.0, 87.0, 19.0 ],
					"text" : "hoa.pi 0.66666"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1006.0, 216.0, 55.0, 19.0 ],
					"text" : "hoa.pi 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 4,
					"outlettype" : [ "int", "signal", "signal", "signal" ],
					"patcher" : 					{
						"fileversion" : 1,
						"appversion" : 						{
							"major" : 6,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 150.0, 360.0, 32.5, 19.0 ],
									"text" : "!- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 230.0, 580.0, 32.5, 19.0 ],
									"text" : "/ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 229.0, 609.0, 41.0, 19.0 ],
									"text" : "* 128."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 255.0, 525.0, 52.0, 19.0 ],
									"text" : "hoa.pi 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 224.0, 549.0, 34.0, 19.0 ],
									"text" : "% 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 223.0, 501.0, 74.0, 19.0 ],
									"text" : "snapshot~ 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 315.0, 450.0, 40.0, 19.0 ],
									"text" : "/~ 50."
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 150.0, 300.0, 55.0, 19.0 ],
													"text" : "hoa.pi 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 120.0, 330.0, 32.5, 19.0 ],
													"text" : "/~"
												}
...
,
					"patching_rect" : [ 705.0, 135.0, 252.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 988.0, 262.0, 35.0, 19.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 204.0, 105.0, 45.0, 19.0 ],
					"text" : "sig~ 0."
				}
...
,
					"patching_rect" : [ 705.0, 15.0, 59.5, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 451.25, 634.0, 238.0, 19.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 750.0, 330.0, 33.0, 19.0 ],
					"text" : "/~ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 750.0, 270.0, 51.0, 19.0 ],
					"text" : "sig~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 750.0, 360.0, 208.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 15.0, 435.0, 208.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 750.0, 420.0, 208.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 495.0, 435.0, 192.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 495.0, 495.0, 192.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 240.0, 385.0, 235.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 240.0, 321.0, 221.5, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 240.0, 270.0, 221.5, 19.0 ],
					"text" : "hoa.rotate~ 7"
				}
...
, 											{
												"box" : 												{
													...
													"prefix" : "Macintosh HD:/Users/elioton/Documents/programmation/CICM/sons_pour_savante_banlieue/",
													"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 705.0, 45.0, 99.0, 19.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 997.5, 285.0, 981.0, 285.0, 981.0, 528.0, 686.5, 528.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"name" : "hoa.toggle.maxpat",
				"bootpath" : "/Users/elioton/Documents/programmation/CICM/sourceTree/HoaLibrary/MaxMsp/SavanteBanlieue",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
