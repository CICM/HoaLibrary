...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 226.0, 458.0, 215.0, 17.0 ],
									"text" : "set 1 1 hoaIr, set 2 1 hoaIr, set 3 1 hoaIr"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 378.125, 420.0, 55.0, 84.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "signal" ],
									"patching_rect" : [ 30.0, 428.0, 107.0, 19.0 ],
									"text" : "multiconvolve~ 3 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 628.0, 328.0, 74.0, 17.0 ],
									"text" : "normalize 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 454.0, 385.0, 70.0, 17.0 ],
									"text" : "buffer hoaIr"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 740.5, 323.0, 65.0, 21.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 739.5, 403.0, 40.0, 19.0 ],
									"text" : "clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 719.5, 323.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 739.5, 428.0, 123.0, 21.0 ],
									"text" : "buffer~ fir_buf 3000"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"patching_rect" : [ 25.0, 39.0, 130.0, 19.0 ],
													"text" : "t b clear"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 25.0, 178.0, 44.0, 19.0 ],
													"text" : "sel 0 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 25.0, 150.0, 44.0, 19.0 ],
													"text" : "decide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 79.0, 225.0, 31.0, 19.0 ],
													"text" : "i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 25.0, 122.0, 34.0, 19.0 ],
													"text" : "sel 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 25.0, 94.0, 44.0, 19.0 ],
													"text" : "decide"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "bang" ],
													"patching_rect" : [ 25.0, 225.0, 49.0, 19.0 ],
													"text" : "urn 128"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 123.0, 197.0, 27.0, 19.0 ],
													"text" : "* 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 123.0, 162.0, 135.0, 19.0 ],
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 25.0, 66.0, 85.0, 19.0 ],
													"text" : "uzi 128 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 79.0, 270.0, 63.0, 19.0 ],
													"text" : "pack 0 0."
												}
...
,
									"patching_rect" : [ 740.5, 353.0, 115.0, 21.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 740.5, 376.0, 87.0, 21.0 ],
									"text" : "peek~ fir_buf"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"order" : 7,
									"patching_rect" : [ 559.625, 532.0, 225.0, 225.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 161.316345, 328.0, 47.0, 19.0 ],
									"text" : "dry $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 307.0, 379.0, 83.0, 19.0 ],
									"text" : "buffer fir_buf"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 545.625, 355.0, 150.0, 19.0 ],
									"text" : "buffer~ hoaIr Chapel-1.wav"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 30.0, 552.0, 53.0, 45.0 ],
									"text" : "hoa.binaural~ 1 small"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "signal" ],
									"patching_rect" : [ 30.0, 258.5, 53.0, 32.0 ],
									"text" : "hoa.encoder~ 1"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 846.0, 424.0, 749.0, 424.0 ],
									"source" : [ "obj-34", 1 ]
								}
