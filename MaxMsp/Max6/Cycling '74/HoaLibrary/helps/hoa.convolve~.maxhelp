...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 337.0, 228.0, 43.0, 21.0 ],
									"text" : "click~"
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 312.683655, 318.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 300.0, 344.0, 49.0, 19.0 ],
									"text" : "wet $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 282.0, 291.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 473.0, 236.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 390.625, 262.0, 38.0, 21.0 ],
									"text" : "*~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 381.0, 160.0, 39.0, 19.0 ],
									"text" : "open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 389.0, 198.0, 320.0, 16.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 378.125, 225.0, 63.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 269.316345, 317.0, 47.0, 19.0 ],
									"text" : "dry $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 307.0, 379.0, 77.0, 19.0 ],
									"text" : "buffer hoaIr"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 545.625, 317.0, 49.0, 17.0 ],
									"text" : "replace"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 545.625, 355.0, 76.0, 19.0 ],
									"text" : "buffer~ hoaIr"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 30.0, 448.0, 235.0, 19.0 ],
