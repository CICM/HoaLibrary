...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 363.375, 447.0, 83.0, 19.0 ],
					"text" : "unpack 0 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 484.0, 72.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.0, 484.0, 72.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 588.0, 459.0, 50.0, 69.0 ],
					"text" : "0 2.430455 -1.930102"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.0, 547.0, 55.0, 19.0 ],
					"text" : "pak 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.875, 569.0, 69.0, 17.0 ],
					"text" : "car 0 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 445.875, 518.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 379.875, 518.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.closer~ weights the harmonics depending to their number and the radius value. It's based on the cicmtool ambipan~ external.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 302.25, 127.0, 79.0, 19.0 ],
					"text" : "loadmess 0.3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 364.5, 153.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.5, 127.0, 70.0, 19.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 240.5, 51.0, 19.0 ],
					"text" : "Theta"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 152.25, 262.5, 56.0, 19.0 ],
					"sig" : 0.0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 30.0, 76.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 242.0, 100.0, 79.0, 19.0 ],
									"text" : "loadmess 2.8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 186.0, 125.0, 79.0, 19.0 ],
									"text" : "loadmess 0.3"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 179.25, 100.0, 34.0, 19.0 ],
													"text" : "* 0.3"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 88.0, 205.0, 42.0, 19.0 ],
													"text" : "hoa.pi"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 50.0, 232.0, 57.0, 19.0 ],
													"text" : "- 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 50.0, 152.0, 80.0, 19.0 ],
													"text" : "snapshot~ 50"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 179.25, 244.0, 87.0, 19.0 ],
													"text" : "* 1.5"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 50.0, 205.0, 32.5, 19.0 ],
													"text" : "* 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 63.5, 177.0, 52.0, 19.0 ],
													"text" : "hoa.pi 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 228.75, 40.0, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 157.0, 187.0, 48.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 186.0, 150.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 242.0, 150.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 107.0, 125.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 50.0, 125.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 161.0, 61.0, 19.0 ],
									"text" : "pack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 187.0, 81.0, 19.0 ],
									"text" : "prepend pol 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 271.963501, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 364.5, 181.0, 48.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 240.5, 53.0, 19.0 ],
					"text" : "Radius"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 97.007812, 295.0, 64.75, 19.0 ],
									"text" : "cartopol~"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 142.757812, 204.0, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 142.757812, 231.0, 71.0, 20.0 ],
									"text" : "pack 0. 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 142.757812, 261.0, 36.0, 20.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "float" ],
									"patching_rect" : [ 97.007812, 173.0, 64.75, 19.0 ],
									"text" : "poltocar"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 142.757812, 141.0, 32.5, 19.0 ],
									"text" : "* -1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "float", "float" ],
									"patching_rect" : [ 50.0, 100.0, 111.757812, 19.0 ],
									"text" : "unpack 0 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 96.0, 374.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 142.007812, 374.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 123.0, 212.5, 121.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 302.25, 147.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 302.25, 173.0, 55.0, 17.0 ],
					"text" : "zoom $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 497.0, 226.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "list", "" ],
					"output_mode" : 1,
					"patching_rect" : [ 302.25, 212.5, 225.25, 225.25 ],
					"zoom" : 0.3
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 545.5, 168.5, 225.25, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 545.75, 212.5, 225.0, 225.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 35.0, 262.5, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.0, 391.0, 225.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.0, 300.5, 199.25, 19.0 ],
...
,
					"patching_rect" : [ 545.5, 59.0, 51.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 545.5, 97.0, 99.0, 19.0 ],
					"saved_object_attributes" : 					{
...
,
					"patching_rect" : [ 19.0, 111.0, 218.0, 87.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 19.0, 355.0, 225.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 19.0, 447.0, 225.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.closer~ by Julien Colafrancesco, Pierre Guillot & Eliott Paris © 2012 CICM / Universite Paris 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 240.5, 44.0, 19.0 ],
					"rounded" : 15,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 240.5, 41.25, 19.0 ],
					"rounded" : 15,
					"shadow" : -1
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 311.75, 438.0, 264.0, 438.0, 264.0, 207.0, 132.5, 207.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.5, 290.0, 28.5, 290.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 132.5, 231.0, 44.5, 231.0 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 234.5, 236.0, 161.75, 236.0 ],
					"source" : [ "obj-41", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 555.0, 80.0, 555.0, 80.0 ],
					"source" : [ "obj-46", 0 ]
				}
