...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 502.0, 211.0, 99.0, 19.0 ],
					"saved_object_attributes" : 					{
						"poscolor" : [ 0.8125, 1.0, 0.894531, 1.0 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.5, 181.0, 100.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 502.0, 146.0, 32.5, 19.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 122.0, 161.0, 17.0 ],
					"text" : "0.8125 1. 0.894531 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 502.0, 77.0, 128.0, 32.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@module", 1, "@wave", 1, "@speed", 80, "@pulse", 1 ],
					"border" : 1,
					"embed" : 1,
					"id" : "obj-36",
					"maxclass" : "bpatcher",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 69.5, 324.0, 65.0, 20.0 ],
									"text" : "clip 0. 150"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 357.0, -2.185425, 20.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 357.0, 29.0, 572.0, 33.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
									"presentation_rect" : [ 400.0, 140.000031, 572.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 488.0, 69.0, 80.500031, 32.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 270.0, 360.0, 103.0, 19.0 ],
...
,
					"patching_rect" : [ 27.0, 268.0, 218.0, 87.0 ]
				}
...
,
					"patching_rect" : [ 315.0, 373.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 14.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 250.0, 782.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 249.0, 782.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 247.0, 498.0, 91.0, 22.0 ],
					"text" : "turn dac~ on",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 194.5, 476.0, 44.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.5, 465.25, 149.5, 62.75 ],
					"rounded" : 15,
					"shadow" : -1
				}
...
,
					"patching_rect" : [ 296.0, 345.0, 51.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 14.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 783.4375, 33.5, 52.0, 23.0 ],
...
,
					"patching_rect" : [ 252.0, 124.5, 218.0, 87.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 913.4375, 250.0, 70.0, 84.0 ],
					"rounded" : 15,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 551.0, 276.0, 257.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.4375, 394.5, 483.0, 56.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 868.4375, 411.0, 52.0, 23.0 ],
					"text" : "bgcolor 0.93 0.93 0.92 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.4375, 461.0, 497.0, 19.0 ],
					"text" : "hoalibrary | Julien Colafrancesco, Pierre Guillot & Eliott Paris © 2012 CICM / Universite Paris 8",
					"textcolor" : [ 0.317518, 0.317518, 0.317518, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.4375, 498.0, 421.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.4375, 498.0, 433.0, 53.0 ],
					"rounded" : 15,
					"shadow" : -1
				}
