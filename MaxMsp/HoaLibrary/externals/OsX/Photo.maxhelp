...
,
		"rect" : [ 127.0, 44.0, 1313.0, 779.0 ],
		"bglocked" : 0,
		"defrect" : [ 127.0, 44.0, 1313.0, 779.0 ],
...
,
						"rect" : [ 555.0, 30.0, 218.0, 87.0 ],
						"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
						"bglocked" : 0,
						"defrect" : [ 555.0, 30.0, 218.0, 87.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 555.0, 30.0, 218.0, 87.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 555.0, 135.0, 227.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 135.0, 201.0, 20.0 ],
...
,
					"patching_rect" : [ 990.0, 135.0, 66.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontsize" : 12.0,
						"default_fontface" : 0,
						"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 300.0, 105.0, 42.0, 20.0 ],
					"text" : "hoa.pi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 255.0, 135.0, 63.5, 20.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 7,
					"patching_rect" : [ 15.0, 300.0, 225.0, 225.0 ],
					"textcolor" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 495.0, 241.5, 241.5 ],
					"textcolor" : [  ]
				}
...
,
					"patching_rect" : [ 975.0, 15.0, 51.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontsize" : 12.0,
						"default_fontface" : 0,
						"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 975.0, 45.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 225.0, 70.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 45.0, 90.0, 20.0 ],
					"text" : "loadmess -1.57"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 737.0, 241.5, 20.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 645.0, 285.0, 42.0, 20.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 645.0, 255.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 315.0, 375.0, 242.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 465.0, 241.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 315.0, 285.0, 227.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 255.0, 105.0, 32.0, 20.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 15.0, 180.0, 227.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 264.5, 165.0, 232.5, 165.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 654.5, 366.0, 549.0, 366.0, 549.0, 372.0, 547.5, 372.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 984.5, 36.0, 984.5, 36.0 ],
					"source" : [ "obj-46", 0 ]
				}
