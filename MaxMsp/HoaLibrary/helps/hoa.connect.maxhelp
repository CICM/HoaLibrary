...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 491.0, 161.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 385.0, 386.0, 32.5, 20.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 428.0, 388.0, 78.0, 20.0 ],
					"text" : "Me neither..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 190.0, 122.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 105.0, 59.5, 20.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 195.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Help to connect hoa library object's together",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 135.0, 199.0, 20.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "lock.js",
				"bootpath" : "/Users/elioton/Dropbox/hoaLibrary/externals/jsExternals",
				"patcherrelativepath" : "../externals/jsExternals",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
				"name" : "hoa.nothing~.maxpat",
				"bootpath" : "/Users/elioton/Dropbox/hoaLibrary/patchs",
