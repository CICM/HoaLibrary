...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 588.0, 95.0, 262.0, 20.0 ],
					"text" : "route size delay feedback rarefaction waveform"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "patcherargs @size 100. @delay 1000 @feedback 0.8 @rarefaction 0.1 @waveform fill sin 1 2"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 157.5, 180.0, 69.0, 20.0 ],
									"text" : "prepend fill"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 33.0, 65.0, 69.0, 20.0 ],
									"text" : "route int fill"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 33.0, 180.0, 111.0, 20.0 ],
									"text" : "sprintf livegrain%ld"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 33.0, 210.0, 74.0, 20.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 33.0, 318.0, 122.0, 19.0 ],
									"text" : "buffer~ livegrain 1000"
								}
...
,
					"patching_rect" : [ 782.400024, 183.5, 101.0, 19.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 707.0, 289.0, 111.0, 20.0 ],
									"text" : "sprintf livegrain%ld"
								}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 597.5, 300.0, 84.5, 300.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 646.099976, 300.0, 144.5, 300.0 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 743.299988, 315.0, 264.5, 315.0 ],
					"source" : [ "obj-13", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 694.700012, 315.0, 204.5, 315.0 ],
					"source" : [ "obj-13", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 354.5, 300.0, 98.0, 300.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 354.5, 300.0, 158.0, 300.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 354.5, 168.0, 330.0, 168.0, 330.0, 315.0, 336.0, 315.0, 336.0, 384.0, 324.5, 384.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 354.5, 171.0, 777.0, 171.0, 777.0, 168.0, 791.900024, 168.0 ],
					"source" : [ "obj-30", 0 ]
				}
