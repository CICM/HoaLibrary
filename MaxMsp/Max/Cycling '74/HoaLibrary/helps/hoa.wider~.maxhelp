...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 240.5, 99.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 254.0, 307.0, 48.0, 20.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.0, 278.0, 67.0, 20.0 ],
					"text" : "pack 0. 50."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 1.0, 120.0, 30.0 ],
					"text" : "hoa.wider~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 31.0, 241.0, 21.0 ],
					"text" : "A fractional ambisonic's orders simulator.",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 296.0, 215.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 7,
					"patching_rect" : [ 30.0, 362.0, 243.0, 243.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 639.0, 243.0, 20.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 254.0, 247.0, 50.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 29.0, 104.0, 218.0, 87.0 ]
				}
...
,
					"patching_rect" : [ 269.0, 134.0, 303.0, 49.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 332.0, 243.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 606.0, 32.5, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 606.0, 72.0, 18.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 606.0, 243.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 496.75, 3.0, 280.0, 33.0 ],
					"text" : "hoa.wider~ by Julien Colafrancesco, Pierre Guillot & Eliott Paris © 2012 CICM / Universite Paris 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 3.0, 120.0, 30.0 ],
					"text" : "hoa.wider~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 241.0, 21.0 ],
					"text" : "A fractional ambisonic's orders simulator.",
					"textcolor" : [ 0.0, 0.0, 0.0, 0.5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 53.0, 564.0, 33.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 374.5, 630.5, 263.5, 630.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 263.5, 353.0, 263.5, 353.0 ],
					"source" : [ "obj-35", 14 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 247.5, 353.0, 247.5, 353.0 ],
					"source" : [ "obj-35", 13 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 231.5, 353.0, 231.5, 353.0 ],
					"source" : [ "obj-35", 12 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 215.5, 353.0, 215.5, 353.0 ],
					"source" : [ "obj-35", 11 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 199.5, 353.0, 199.5, 353.0 ],
					"source" : [ "obj-35", 10 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 183.5, 353.0, 183.5, 353.0 ],
					"source" : [ "obj-35", 9 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 167.5, 353.0, 167.5, 353.0 ],
					"source" : [ "obj-35", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 151.5, 353.0, 151.5, 353.0 ],
					"source" : [ "obj-35", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 135.5, 353.0, 135.5, 353.0 ],
					"source" : [ "obj-35", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 119.5, 353.0, 119.5, 353.0 ],
					"source" : [ "obj-35", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 103.5, 353.0, 103.5, 353.0 ],
					"source" : [ "obj-35", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 87.5, 353.0, 87.5, 353.0 ],
					"source" : [ "obj-35", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 71.5, 353.0, 71.5, 353.0 ],
					"source" : [ "obj-35", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 55.5, 353.0, 55.5, 353.0 ],
					"source" : [ "obj-35", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 39.5, 353.0, 39.5, 353.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 278.5, 185.0, 278.0, 185.0, 278.0, 224.0, 39.5, 224.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 294.5, 630.5, 263.5, 630.5 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				...
				"bootpath" : "\\PROGRA~2\\CYCLIN~1\\MAX6~1.0\\Cycling '74\\HoaLibrary\\effects",
				"patcherrelativepath" : "..\\..\\..\\..\\..\\..\\..\\..\\..\\..\\PROGRA~2\\CYCLIN~1\\MAX6~1.0\\Cycling '74\\HoaLibrary\\effects",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
