...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 225.0, 62.0, 19.0 ],
					"text" : "phasor~ 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 459.0, 464.0, 46.0, 17.0 ],
					"text" : "open 0"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 206.0, 205.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 238.0, 85.0, 19.0 ],
					"text" : "prepend depth"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1087.0, 285.0, 168.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 849.0, 285.0, 70.0, 19.0 ],
					"text" : "loadmess 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 15,
					"numoutlets" : 0,
					"patching_rect" : [ 814.0, 447.0, 279.571442, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1156.571411, 165.0, 55.0, 19.0 ],
					"text" : "hoa.pi 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1074.571411, 225.0, 32.5, 19.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1074.571411, 150.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1074.571411, 117.0, 79.0, 19.0 ],
					"text" : "loadmess 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1074.571411, 180.0, 72.0, 19.0 ],
					"text" : "phasor~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 814.0, 398.0, 279.571442, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 814.0, 353.083344, 247.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 814.0, 544.0, 279.571442, 19.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 814.0, 504.0, 279.571442, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 362.0, 251.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 362.0, 225.0, 76.0, 19.0 ],
					"text" : "loadmess 10"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.plug~ 7 hoa.send~ post @name flo"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.plug~ 7 hoa.receive~ post @name flo"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.am~ creates a diffused soundfield by modulating the amplitude of the spherical harmonics signal dependinbg to their number.",
					"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 30.0, 389.0, 269.0, 19.0 ],
					"text" : "hoa.plug~ 7 hoa.flanger~ post"
				}
