...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : -45.0,
					"patching_rect" : [ 513.0, 122.0, 225.0, 225.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : -22.5,
					"patching_rect" : [ 406.0, 346.0, 225.0, 225.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 45.0, 222.0, 42.0, 19.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 357.0, 238.0, 42.0, 19.0 ],
					"text" : "sig~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : -90.0,
					"patching_rect" : [ 45.0, 317.0, 193.0, 193.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.0, 165.0, 41.0, 19.0 ],
					"text" : "*~ 30."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.0, 195.0, 46.0, 19.0 ],
					"text" : "/~ 360."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 300.0, 195.0, 55.0, 19.0 ],
					"text" : "hoa.pi 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 481.0, 32.5, 17.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 450.0, 72.0, 17.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 523.0, 208.0, 19.0 ],
					"text" : "hoa.dac~ 1:2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.0, 225.0, 51.0, 19.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 255.0, 208.0, 19.0 ],
					"text" : "hoa.encoder~ 7"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "An ambisonic projector to stereophonic system",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 56.0, 579.0, 32.0 ],
					"text" : "hoa.stereo~ decodes an ambisonic soundfield for stereophonic system. First argument is the order of the ambisonic soundfield, second argument is the angle in degrees between 0° and a loudspeaker.",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 338.5, 519.0, 243.5, 519.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 324.5, 519.0, 264.0, 519.0, 264.0, 519.0, 243.5, 519.0 ],
					"source" : [ "obj-8", 0 ]
				}
