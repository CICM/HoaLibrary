...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 387.558044, 416.5, 0.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 490.0, 270.0, 42.0, 19.0 ],
									"text" : "sig~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 255.0, 307.0, 239.3125, 19.0 ],
...
,
					"patching_rect" : [ 297.0, 161.0, 47.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 14.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 15,
									"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 285.0, 315.0, 208.0, 19.0 ],
									"text" : "hoa.plug~ 7 hoa.all post"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 16,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
									"patching_rect" : [ 130.0, 386.0, 221.5, 19.0 ],
									"text" : "hoa.decoder~ 7 16"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 385.0, 386.0, 32.5, 19.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 75.0, 315.0, 32.5, 19.0 ],
									"text" : "+~"
								}
...
,
					"patching_rect" : [ 295.0, 135.0, 58.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 14.0,
...
,
					"patching_rect" : [ 351.25, 134.5, 50.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 13.0,
