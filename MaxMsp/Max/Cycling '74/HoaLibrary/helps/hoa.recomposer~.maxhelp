...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 527.875, 300.0, 131.25, 47.0 ],
					"text" : "Fish eye factor (0 - 1) : Contraction of the soundfield",
					"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
					"varname" : "autohelp_top_description[2]"
				}
