...
, 							{
								"box" : 								{
									...
									"text" : "hoa.optim~ applies an optimization to the cylindrical harmonics.\nIt can be \"basic\" for no optimization, \"maxRe\" or \"inPhase\".",
									"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
