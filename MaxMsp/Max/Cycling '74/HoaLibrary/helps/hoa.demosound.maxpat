...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.5, 369.0, 65.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 65.5, 322.0, 65.0, 20.0 ],
					"text" : "clip 0. 150"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 135.0, 405.0, 12.0, 80.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 195.0, 0.0, 12.0, 80.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 120.0, 405.0, 12.0, 80.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.0, 0.0, 12.0, 80.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 444.0, 163.370789, 91.0, 20.0 ],
									"text" : "prepend speed"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 448.0, 138.0, 87.0, 20.0 ],
									"text" : "prepend pulse"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 251.0, 155.0, 81.0, 20.0 ],
									"text" : "prepend freq"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 11,
									"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 50.0, 100.0, 379.0, 20.0 ],
									"text" : "route module vol loop file wave freq noise filter speed pulse"
								}
...
,
					"patching_rect" : [ 555.0, 345.0, 73.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 641.0, 238.0, 379.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 402.0, 42.814575, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 396.0, 112.814606, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 402.0, 74.0, 572.0, 34.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 396.0, 138.000031, 572.0, 34.0 ],
					"text" : "patcherargs @module 0 @vol 128 @loop 0 @file 2 @wave 0 @freq 440 @noise 0 @filter 0 @speed 200 @pulse 0"
				}
...
,
					"patching_rect" : [ 690.0, 430.000031, 110.0, 61.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 20.0, 175.0, 66.741623 ],
					"varname" : "fourth"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 120.0, 173.736938, 179.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 179.0, 20.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 533.0, 114.0, 80.500031, 32.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 66.0, 228.0, 74.0, 32.0 ],
					"text" : ";\r\nmax refresh"
				}
...
,
						...
						"digest" : "",
						"tags" : "",
						"globalpatchername" : "[1][1][1][3][1][1][3][2][1][1][1][1][1][2][3][3][1][1][1][1][1][1][1][2][2][1][1]",
						"boxes" : [ 							{
								"box" : 								{
									"fontname" : "Arial",
									"fontsize" : 11.595187,
...
,
					"patching_rect" : [ 120.0, 207.000031, 106.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 160.000031, 106.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 285.0, 78.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 188.454483, 161.77652, 78.0, 18.0 ],
					"text" : "clear, $1 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 120.0, 240.000031, 69.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 193.000031, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.0, 458.629211, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "list" ],
					"patching_rect" : [ 315.0, 510.0, 394.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 266.0, 463.0, 394.0, 20.0 ],
...
,
					"patching_rect" : [ 565.0, 430.000031, 106.0, 61.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 20.0, 179.481781, 66.0 ],
					"varname" : "third"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 54.833344, 110.0, 161.0, 20.0 ],
									"text" : "route wave freq speed pulse"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 293.241211, 390.947357, 87.0, 20.0 ],
									"text" : "loadmess 500"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 150.333344, 146.947357, 26.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 90.333344, 147.947357, 47.0, 18.0 ],
									"presentation" : 1,
...
,
					"patching_rect" : [ 439.714111, 430.000031, 106.0, 61.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 20.0, 178.481781, 65.0 ],
					"varname" : "second"
				}
...
,
					"patching_rect" : [ 314.714111, 430.000031, 106.0, 61.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 20.0, 178.754517, 65.090912 ],
					"varname" : "first"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 465.0, 270.0, 46.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 416.0, 223.0, 46.0, 18.0 ],
					"text" : "t f b b"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 311.0, 163.0, 32.5, 18.0 ],
					"text" : "- 70."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 281.0, 163.0, 32.5, 18.0 ],
					"text" : "- 70."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 330.0, 300.0, 49.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 281.0, 253.0, 49.0, 18.0 ],
					"text" : "poltocar"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 270.0, 32.5, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 281.0, 223.0, 32.5, 16.0 ],
					"text" : "65"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 330.0, 240.0, 48.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 281.0, 193.0, 48.0, 18.0 ],
					"text" : "cartopol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 615.0, 225.0, 70.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 566.0, 178.0, 70.0, 20.0 ],
					"text" : "sprintf clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 600.0, 255.0, 183.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 551.0, 208.0, 183.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 480.0, 345.0, 33.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 431.0, 298.0, 33.0, 20.0 ],
					"text" : "+ 73"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 419.0, 345.0, 33.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 370.0, 298.0, 33.0, 20.0 ],
					"text" : "+ 73"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 360.0, 345.0, 33.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 311.0, 298.0, 33.0, 20.0 ],
					"text" : "+ 67"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 315.0, 349.0, 33.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 266.0, 302.0, 33.0, 20.0 ],
					"text" : "+ 67"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 390.0, 96.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 266.0, 343.0, 96.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 405.0, 103.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 266.0, 358.0, 103.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 330.0, 180.0, 48.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 281.0, 133.0, 48.0, 20.0 ],
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 90.0, 95.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 43.0, 95.0, 20.0 ],
					"text" : "loadmess 70 70"
				}
