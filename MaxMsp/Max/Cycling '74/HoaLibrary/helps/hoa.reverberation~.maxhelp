...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 281.0, 78.0, 19.0 ],
					"text" : "append 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "clear" ],
					"patching_rect" : [ 343.666656, 205.0, 54.0, 19.0 ],
					"text" : "t l l clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 357.0, 305.0, 105.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.0, 197.0, 117.0, 19.0 ],
					"text" : "append 180 180 180"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 609.0, 213.0, 32.5, 19.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 609.0, 246.0, 32.5, 19.0 ],
					"text" : "/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 522.0, 216.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 553.0, 191.0, 32.5, 19.0 ],
					"text" : "!/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 419.0, 147.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.0, 227.0, 101.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 331.5, 120.0, 41.0, 19.0 ],
					"text" : "* 173."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.5, 178.0, 68.0, 19.0 ],
					"text" : "pak 0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 275.0, 133.0, 40.0, 19.0 ],
					"text" : "!- 173"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 350.666656, 147.0, 40.0, 19.0 ],
					"text" : "+ 173"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 522.0, 72.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "hoa.reverberation~", "@obj-desc", "An", "ambisonics", "reverberation", "plug~", "effect" ],
					"id" : "obj-28",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"text" : "hoa.reverberation~ use an algorithm based on feedback network delay and doppler effect to simulate a room reveberation. It can also be usefull to create a distance parameter.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 651.5, 646.0, 121.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 651.5, 627.0, 64.0, 19.0 ],
					"text" : "s polcoord"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 646.0, 121.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 156.0, 292.0, 53.0, 32.0 ],
					"text" : "doppler on/off"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 136.0, 298.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 324.0, 58.0, 19.0 ],
					"text" : "s doppler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.5, 74.0, 38.0, 19.0 ],
					"text" : "r size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.5, 227.0, 37.0, 19.0 ],
					"text" : "in Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 227.0, 58.0, 19.0 ],
					"text" : "in meters"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 627.0, 58.0, 19.0 ],
					"text" : "s revspat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 324.0, 62.0, 19.0 ],
					"text" : "s diffusion"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.5, 271.0, 70.0, 19.0 ],
					"text" : "s frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 271.0, 50.0, 19.0 ],
					"text" : "s decay"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 271.0, 40.0, 19.0 ],
					"text" : "s size"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 488.0, 271.0, 346.0, 346.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 210.0, 299.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 214.5, 246.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 318.0, 246.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 136.0, 246.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 299.0, 79.0, 19.0 ],
					"text" : "loadmess 0.7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 136.0, 246.0, 73.0, 19.0 ],
					"text" : "loadmess 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 246.0, 79.0, 19.0 ],
					"text" : "loadmess 0.6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.5, 246.0, 92.0, 19.0 ],
					"text" : "loadmess 6000."
				}
