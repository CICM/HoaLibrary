...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 282.0, 229.0, 32.5, 19.0 ],
					"text" : "* 2."
				}
...
,
					"patching_rect" : [ 517.75, 134.0, 48.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 546.75, 165.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 546.75, 97.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 658.75, 97.0, 34.0, 19.0 ],
					"text" : "Amp"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 602.75, 97.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 467.75, 104.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 410.75, 104.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 410.75, 140.0, 61.0, 19.0 ],
					"text" : "pack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 410.75, 166.0, 81.0, 19.0 ],
					"text" : "prepend pol 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 410.75, 464.0, 87.0, 19.0 ],
					"text" : "snapshot~ 100"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 25.0, 271.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 115.0, 160.0, 48.0, 19.0 ],
									"text" : "line~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 155.0, 197.0, 63.0, 20.0 ],
									"text" : "hoa.pi 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 115.0, 237.0, 59.0, 20.0 ],
									"text" : "-~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 25.0, 197.0, 109.0, 19.0 ],
									"text" : "cartopol~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 115.0, 271.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 410.75, 432.0, 50.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 14.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 410.75, 194.5, 230.0, 230.0 ],
					"speaker_number" : 16,
					"zoom" : 0.162109
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 181.0, 258.0, 79.0, 19.0 ],
					"text" : "loadmess 1.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 258.0, 73.0, 19.0 ],
					"text" : "loadmess 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.0, 258.0, 70.0, 19.0 ],
					"text" : "loadmess 6"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 305.0, 284.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.0, 312.0, 98.0, 17.0 ],
					"text" : "max_distance $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 480.0, 225.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 94.0, 284.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 312.0, 70.0, 17.0 ],
					"text" : "distance $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 181.0, 284.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 181.0, 312.0, 118.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 398.0, 199.25, 19.0 ],
					"text" : "hoa.plug~ 7 hoa.distance~ pre"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 4.0, 150.0, 30.0 ],
					"text" : "hoa.distance~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.75, 512.0, 32.5, 17.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 512.0, 72.0, 17.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 557.0, 225.0, 19.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
,
					"patching_rect" : [ 61.0, 141.0, 218.0, 87.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 15,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 61.0, 440.0, 225.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 512.0, 225.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 6.0, 150.0, 30.0 ],
					"text" : "hoa.distance~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 56.0, 320.0, 19.0 ],
					"text" : "hoa.distance~ map several parameters to simulate distance.",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 399.25, 542.0, 276.5, 542.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 321.5, 542.0, 276.5, 542.0 ],
					"source" : [ "obj-7", 0 ]
				}
