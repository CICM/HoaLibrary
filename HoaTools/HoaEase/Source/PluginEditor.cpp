...
void HoaplugAudioProcessorEditor::buttonClicked (Button *button)
{
    ;
}
void HoaplugAudioProcessorEditor::buttonStateChanged (Button *button)
{
    ;
}
...
void HoaplugAudioProcessorEditor::checkAllProcessorValues()
{
    HoaplugAudioProcessor* ourProcessor = getProcessor();
    
    // set the distance
    speakerDistance_Slider.setValue (ourProcessor->getScaledParameter(HoaplugAudioProcessor::m_distance_of_loudspeakers_parameter), dontSendNotification);
    theMap.setSpeakerDistance(ourProcessor->getScaledParameter(HoaplugAudioProcessor::m_distance_of_loudspeakers_parameter), dontSendNotification);
    
    // set the offset
    speakerOffset_Slider.setValue (ourProcessor->getScaledParameter(HoaplugAudioProcessor::m_offset_of_loudspeakers_parameter), dontSendNotification);
    theMap.setSpeakerOffset(ourProcessor->getScaledParameter(HoaplugAudioProcessor::m_offset_of_loudspeakers_parameter), dontSendNotification);
...
void HoaplugAudioProcessorEditor::changeListenerCallback (ChangeBroadcaster* source)
{
    if (source == &theMap) {
        ...
        getProcessor()->setParameterNotifyingHost (HoaplugAudioProcessor::m_offset_of_loudspeakers_parameter, (float) (speakerOffset_Slider.getValue()+ 180.0f)/360.0f);
    }
