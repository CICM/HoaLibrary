...
,
					"patching_rect" : [ 750.0, 44.0, 69.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 750.0, 74.0, 74.0, 19.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 599.0, 26.0, 52.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 217.0, 395.5, 235.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 479.0, 102.0, 126.25, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.399994, 102.0, 194.850006, 32.0 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.5, 102.0, 126.25, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 681.0, 375.0, 161.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 681.0, 159.0, 161.0, 45.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.5, 440.0, 161.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.5, 440.0, 379.850006, 32.0 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.5, 238.0, 161.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.5, 238.0, 379.850006, 32.0 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.350006, 349.0, 193.5, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.350006, 152.5, 175.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 489.910095, 375.0, 180.0, 180.0 ]
				}
...
,
					"patching_rect" : [ 216.75, 108.5, 69.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 7,
					"patching_rect" : [ 489.5, 159.0, 180.0, 180.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.25, 489.0, 32.5, 17.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.5, 489.0, 72.0, 17.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 562.0, 221.5, 19.0 ],
					"text" : "hoa.dac~ 1:16"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 216.75, 159.0, 222.199997, 19.0 ],
					"text" : "hoa.encoder~ 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 217.0, 355.0, 221.5, 20.0 ],
					"saved_object_attributes" : 					{
						"angles" : [ 0.0, 22.5, 45.0, 67.5, 90.0, 112.5, 135.0, 157.5, 180.0, 202.5, 225.0, 247.5, 270.0, 292.5, 315.0, 337.5 ],
						"autoconnect" : 1,
						"channels" : 16,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.5, 73.0, 70.0, 19.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 419.5, 108.5, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.350006, 349.0, 421.0, 32.0 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.350006, 152.5, 421.0, 33.5 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.350006, 13.0, 537.0, 58.0 ],
					"text" : "Dans cet exemple, une source sonore est encodée dans un espace à deux dimensions selon un angle d'incidence. Le champ sonore comprend la source sonore et ses informations spatiales sous forme de signaux dépendant des harmoniques circulaires . Par la suite, le champ sonore est décodé pour un ensemble de haut-paleurs.",
					"textcolor" : [ 0.317518, 0.317518, 0.317518, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 479.0, 362.0, 363.0, 203.0 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.5, 102.0, 223.850006, 32.0 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 479.0, 146.0, 363.0, 203.0 ],
					"rounded" : 6,
					"shadow" : -1
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 183.75, 549.0, 226.5, 549.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 759.5, 65.0, 759.5, 65.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 106.0, 549.0, 226.5, 549.0 ],
					"source" : [ "obj-7", 0 ]
				}
