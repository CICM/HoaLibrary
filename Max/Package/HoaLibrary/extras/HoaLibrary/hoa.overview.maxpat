...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1990.0, 307.0, 70.0, 20.0 ],
									"text" : "renumber"
								}
...
, 							{
								"box" : 								{
									...
									"spacing_x" : 15.0,
									"spacing_y" : 15.0,
									"tabs" : [ "hoa.scope~", "hoa.meter~", "hoa.map", "hoa.space", "hoa.recomposer", "hoa.gain~" ]
								}
...
, 							{
								"box" : 								{
									...
									"spacing_x" : 20.0,
									"spacing_y" : 5.0,
									"tabs" : [ "hoa.encoder~", "hoa.decoder~", "hoa.rotate~", "hoa.plug~", "hoa.connect", "hoa.dac~", "hoa.pi", "hoa.pi~", "hoa.scope~", "hoa.projector~", "hoa.recomposer~", "hoa.recomposer", "hoa.meter~", "hoa.gain~", "hoa.record~", "hoa.play~", "hoa.optim~", "hoa.map", "hoa.map~", "hoa.convolve~", "hoa.wider~", "hoa.freeverb~", "hoa.space", "hoa.space~", "hoa.vector~" ]
								}
