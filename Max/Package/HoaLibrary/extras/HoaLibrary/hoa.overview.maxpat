...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ -165.0, 428.117065, 32.5, 22.0 ],
					"style" : "",
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -165.0, 525.117065, 56.0, 22.0 ],
					"style" : "",
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -165.0, 185.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -211.4375, 129.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -128.0, 369.5, 74.0, 22.0 ],
					"style" : "",
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -165.0, 285.5, 164.0, 76.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -61.9375, 30.75, 55.0, 17.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.78125, 63.75, 33.28125, 17.0 ],
					"style" : "",
					"text" : "grow"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ -269.9375, 10.75, 46.0, 22.0 ],
					"style" : "",
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -6.21875, 63.75, 13.0, 13.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -269.9375, 45.75, 177.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -253.4375, 68.75, 190.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ -149.9375, 611.75, 143.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0625, 473.5, 6.0, 80.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0625, 469.5, 664.6875, 87.25 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -269.9375, 95.25, 69.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 532.5, 778.0, 81.0, 20.0 ],
									"style" : "",
									"text" : "prepend load",
									"varname" : "phelp[2]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 439.5, 778.0, 83.0, 20.0 ],
									"style" : "",
									"text" : "prepend help",
									"varname" : "phelp[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 439.5, 808.5, 56.0, 20.0 ],
									"style" : "",
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 439.5, 747.0, 112.0, 20.0 ],
									"style" : "",
									"text" : "gate 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 489.5, 720.0, 24.0, 20.0 ],
									"style" : "",
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 439.5, 720.0, 24.0, 20.0 ],
									"style" : "",
									"text" : "t 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 439.5, 644.0, 73.0, 20.0 ],
									"style" : "",
									"text" : "fromsymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 425.5, 605.0, 33.0, 20.0 ],
									"style" : "",
									"text" : "t s s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 439.5, 693.0, 69.0, 20.0 ],
									"style" : "",
									"text" : "sel Tutorial"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 3.0, 54.0, 657.875, 228.0 ],
									"rounded" : 0.0,
									"spacing_x" : 20.0,
									"spacing_y" : 5.0,
									"style" : "",
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 435.0, 685.5, 542.0, 685.5 ],
									"source" : [ "obj-17", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 542.0, 802.75, 449.0, 802.75 ],
									"source" : [ "obj-28", 0 ]
								}
...
,
					"patching_rect" : [ 18.0625, 171.257935, 664.5625, 284.25 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -51.9375, 10.75, 45.0, 19.0 ],
					"style" : "",
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0625, 171.257935, 664.5625, 292.25 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
