...
, 							{
								"box" : 								{
									...
									"text" : "hoa.process~ 3 hoa.fx.convolve~ harmonics @buffer hoaIr @channel 1"
								}
...
, 							{
								"box" : 								{
									"args" : [ "@obj-name", "hoa.fx.convolve~", "@obj-desc", "An", "ambisonics", "zero", "latency", "convolution", "reverberation" ],
									"id" : "obj-17",
									"maxclass" : "bpatcher",
