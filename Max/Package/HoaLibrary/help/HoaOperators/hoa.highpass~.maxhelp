...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 524.4375, 272.0, 198.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.375, 534.75, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.875, 93.0, 54.0, 16.0 ],
					"text" : "onepole~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.4375, 91.0, 561.0, 20.0 ],
					"text" : "you can take a look at the vanilla object to see more information about it :                   (highpass tab)",
					"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.4375, 68.0, 594.0, 20.0 ],
					"text" : "hoa.highpass~ is a multichannel version of the onepole~ object.",
					"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "hoa.highpass~", "@obj-desc", "A multichannel version of the onepole~ object" ],
					"id" : "obj-41",
					"maxclass" : "bpatcher",
