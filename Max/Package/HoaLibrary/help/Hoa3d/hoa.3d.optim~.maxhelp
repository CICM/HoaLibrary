...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-41",
									"ignoreclick" : 1,
									"jsarguments" : [ "hoa.3d.optim~", 10 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 327.125, 398.25, 250.0, 54.5 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.25, 215.5, 79.0, 19.0 ],
									"text" : "loadmess 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 293.5, 219.5, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 293.5, 249.5, 72.0, 19.0 ],
									"text" : "phasor~ 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 293.5, 320.5, 49.0, 19.0 ],
									"text" : "hoa.pi~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 293.5, 277.5, 96.0, 32.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 165.25, 320.5, 62.0, 19.0 ],
									"text" : "hoa.pi~ 2."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 293.5, 190.5, 79.0, 19.0 ],
									"text" : "loadmess 0.1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 165.25, 234.5, 117.0, 20.0 ],
									"text" : "Azimuth (0 -  2*π) ",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 352.125, 320.5, 127.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 165.25, 261.5, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 165.25, 291.5, 72.0, 19.0 ],
									"text" : "phasor~ 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 337.0, 339.5, 70.0, 19.0 ],
									"text" : "loadmess 2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 337.0, 364.5, 100.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 37.0, 405.25, 275.5, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 20,
									"numoutlets" : 0,
									"patching_rect" : [ 37.0, 662.25, 275.5, 19.0 ],
									"text" : "hoa.dac~ 1:20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"order" : 3,
									"patching_rect" : [ 352.125, 497.0, 184.25, 184.25 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 549.875, 636.25, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "hoa.3d.optim~ weights the spherical harmonics signals depending on the ambisonic optimization. It can be \"basic\" for no optimization, \"maxRe\" or \"inPhase\".",
									"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 							{
								"box" : 								{
									"args" : [ "@obj-name", "hoa.3d.optim~", "@obj-desc", "A 3D ambisonic optimization tool" ],
									"id" : "obj-56",
									"maxclass" : "bpatcher",
...
, 							{
								"box" : 								{
									"args" : [ "@module", 1, "@wave", 2, "@vol", 100, "@freq", 10 ],
									"border" : 1,
									"id" : "obj-55",
									"maxclass" : "bpatcher",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 16,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
									"patching_rect" : [ 37.0, 346.5, 275.5, 19.0 ],
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 387.0, 391.625, 303.0, 391.625 ],
									"source" : [ "obj-13", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 303.0, 460.125, 526.875, 460.125 ],
									"source" : [ "obj-19", 15 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 46.5, 460.125, 361.625, 460.125 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 174.75, 282.5, 174.75, 282.5 ],
									"source" : [ "obj-39", 0 ]
								}
