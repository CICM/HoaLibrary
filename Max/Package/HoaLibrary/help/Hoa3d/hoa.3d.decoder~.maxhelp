...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 289.25, 306.0, 0.0, 0.0 ],
									"text" : "hoa.pi~ 2."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 318.25, 315.0, 62.0, 19.0 ],
									"text" : "hoa.pi~ 2."
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 291.0, 590.0, 0.0, 0.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 375.75, 394.0, 249.0, 19.0 ],
									"text" : "hoa.3d.process~ 1 hoa.fx.gain~ harmonics 10."
								}
...
, 							{
								"box" : 								{
									"args" : [ "@obj-name", "hoa.2d.decoder~", "@obj-desc", "A 3D ambisonic decoder" ],
									"id" : "obj-56",
									"maxclass" : "bpatcher",
...
,
									"patching_rect" : [ 696.0, 485.5, 69.0, 19.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 696.0, 515.5, 74.0, 19.0 ],
									"saved_object_attributes" : 									{
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 327.75, 381.25, 557.75, 381.25 ],
									"source" : [ "obj-34", 3 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 234.0, 381.25, 500.25, 381.25 ],
									"source" : [ "obj-34", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 140.25, 381.25, 442.75, 381.25 ],
									"source" : [ "obj-34", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 46.5, 381.25, 385.25, 381.25 ],
									"source" : [ "obj-34", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 187.125, 269.0, 187.125, 269.0 ],
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 327.75, 269.0, 327.75, 269.0 ],
									"source" : [ "obj-41", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 705.5, 506.5, 705.5, 506.5 ],
									"source" : [ "obj-46", 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 251.625, 248.0, 58.0, 19.0 ],
									"text" : "loadbang"
								}
