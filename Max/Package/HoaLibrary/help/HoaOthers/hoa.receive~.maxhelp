...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 374.5, 474.75, 80.0, 20.0 ],
					"text" : "turn dac~ on",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 322.0, 452.75, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 316.0, 446.0, 147.0, 57.0 ],
					"rounded" : 0
				}
...
,
					"patching_rect" : [ 629.0, 126.0, 76.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 629.0, 156.0, 74.0, 19.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 533.0, 197.5, 132.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 117.5, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 316.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 239.0, 342.0, 49.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 239.0, 371.0, 53.0, 20.0 ],
					"text" : "hoa.pi 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 316.0, 143.5, 49.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 316.0, 172.5, 53.0, 20.0 ],
					"text" : "hoa.pi 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 20.0, 172.5, 43.0, 20.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.0, 245.5, 315.0, 20.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.0, 210.5, 315.0, 20.0 ],
					"text" : "hoa.encoder~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 9,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 289.5, 357.285706, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 614.0, 245.5, 65.0, 18.0 ],
					"text" : "set charlie"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 533.0, 245.5, 60.0, 18.0 ],
					"text" : "set tango"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 533.0, 342.0, 170.0, 170.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 20.0, 364.0, 43.0, 20.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 20.0, 437.0, 238.0, 20.0 ],
					"saved_object_attributes" : 					{
						"angles" : [ 0.0, 45.0, 90.0, 135.0, 180.0, 225.0, 270.0, 315.0 ],
						"autoconnect" : 1,
						"channels" : 8,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 20.0, 402.0, 238.0, 20.0 ],
					"text" : "hoa.encoder~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 533.0, 281.5, 170.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 9,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 481.0, 269.285706, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 565.4375, 73.0, 81.0, 20.0 ],
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.875, 92.0, 50.0, 16.0 ],
					"text" : "receive~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 565.4375, 101.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.4375, 90.0, 594.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.4375, 67.0, 594.0, 20.0 ],
					"text" : "hoa.receive~ is a multichannel version of the receive~ object.",
					"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "hoa.receive~", "@obj-desc", "A multichannel version of the receive~ object" ],
					"id" : "obj-41",
					"maxclass" : "bpatcher",
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 638.5, 147.0, 638.5, 147.0 ],
					"source" : [ "obj-1", 0 ]
				}
