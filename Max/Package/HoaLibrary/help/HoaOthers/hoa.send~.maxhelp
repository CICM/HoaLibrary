...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 531.0, 239.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.285706, 226.75, 65.0, 18.0 ],
					"text" : "set charlie"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 277.428558, 226.75, 60.0, 18.0 ],
					"text" : "set tango"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 26.0, 226.75, 239.0, 20.0 ],
					"saved_object_attributes" : 					{
						"angles" : [ 0.0, 45.0, 90.0, 135.0, 180.0, 225.0, 270.0, 315.0 ],
						"autoconnect" : 1,
						"channels" : 8,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 9,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 261.75, 270.428558, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.875, 91.0, 39.0, 16.0 ],
					"text" : "send~"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 356.785706, 254.75, 286.928558, 254.75 ],
					"source" : [ "obj-19", 0 ]
				}
