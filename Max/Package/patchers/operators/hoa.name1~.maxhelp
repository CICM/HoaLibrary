...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.0, 207.25, 299.0, 58.5 ],
					"presentation_rect" : [ 173.0, 205.25, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 289.0, 132.25, 32.0, 14.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.4375, 129.5, 259.0, 20.0 ],
					"text" : "to achieve this kind of operation on two signals",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.4375, 232.5, 56.0, 22.0 ],
					"presentation_rect" : [ 22.4375, 232.5, 0.0, 0.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 21.4375, 199.5, 75.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 21.4375, 164.5, 56.0, 22.0 ],
					"sig" : 1.4
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 77.9375, 164.5, 56.0, 22.0 ],
					"sig" : 1.4
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 58.0, 564.4375, 60.0 ],
					"rounded" : 15,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.4375, 129.5, 207.5, 20.0 ],
					"text" : "you need to naming each one before",
					"textcolor" : [ 0.30292, 0.30292, 0.30292, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 337.4375, 164.5, 56.0, 22.0 ],
					"sig" : 1.6
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 567.4375, 284.5, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 496.4375, 284.5, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 425.4375, 284.5, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 517.4375, 164.5, 56.0, 22.0 ],
					"sig" : 2.6
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 79.9375, 323.5, 91.0, 22.0 ],
					"text" : "turn dac~ on",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 27.4375, 301.5, 44.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.4375, 290.75, 149.5, 62.75 ],
					"rounded" : 15,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "hoa.name1~", "@obj-desc", "hoa.2d.process~", "utility", "to", "name", "a", "signal" ],
					"id" : "obj-41",
					"maxclass" : "bpatcher",
