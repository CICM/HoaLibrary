...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"order" : 6,
									"patching_rect" : [ 45.433334, 367.0, 219.964279, 219.964279 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 423.0, 122.0, 33.0, 17.0 ],
									"text" : "0.25"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 408.0, 106.0, 32.5, 17.0 ],
									"text" : "0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 314.0, 97.0, 32.5, 17.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 609.0, 290.0, 45.0, 45.0 ]
								}
...
,
									"patching_rect" : [ 884.0, 124.0, 76.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 884.0, 154.0, 89.0, 19.0 ],
									"saved_object_attributes" : 									{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 246.5, 190.0, 42.0, 19.0 ],
									"text" : "hoa.pi"
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 246.5, 142.0, 82.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 145.25, 182.0, 42.0, 19.0 ],
									"text" : "hoa.pi"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 145.25, 154.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 49,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
									"patching_rect" : [ 44.0, 230.0, 667.0, 19.0 ],
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 893.5, 145.0, 893.5, 145.0 ],
									"source" : [ "obj-47", 0 ]
								}
