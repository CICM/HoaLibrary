...
/**
 @file      hoa.3d.gl.scope~.cpp
 @name      hoa.3d.gl.scope~
 @realname  hoa.3d.gl.scope~
 @type      object
 @module    hoa
 ...
 @description
 <o>hoa.3d.gl.scope~</o> displays spherical harmonics of an ambisonic sound field (OpenGL version)
 ...
 @seealso hoa.3d.scope~, hoa.2d.scope~, hoa.3d.decoder~, hoa.3d.encoder~, hoa.3d.map~, hoa.3d.optim~, hoa.3d.vector~, hoa.3d.wider~, hoa.dac~
 
 @illustration on @caption the hoa.3d.gl.scope~ GUI object
 @palette yes
 */
...
int C74_EXPORT main(void)
{
	...
	c = class_new("hoa.3d.gl.scope~", (method)hoa_scope_new, (method)hoa_scope_free, sizeof(t_hoa_scope), 0L, A_GIMME, 0);
	...
	// @description Sets the RGBA values for the background color of the <o>hoa.3d.gl.scope~</o> object
	...
	// @description Sets the RGBA values for the border color of the <o>hoa.3d.gl.scope~</o> object
	...
	// @description Sets the RGBA values for the positive harmonics color of the <o>hoa.3d.gl.scope~</o> object
	...
	// @description Sets the RGBA values for the negative harmonics color of the <o>hoa.3d.gl.scope~</o> object
	...
	// @description Sets the RGBA values for the sphere color of the <o>hoa.3d.gl.scope~</o> object
