...
void hoa_3d_optim_perform64(t_hoa_3d_optim *x, t_object *dsp64, double **ins, long numins, double **outs, long numouts, long sampleframes, long flags, void *userparam);
...
void *hoa_3d_optim_new(t_symbol *s, long argc, t_atom *argv)
{
	...
	t_hoa_3d_optim *x = NULL;
	int	order = 1;
    x = (t_hoa_3d_optim *)object_alloc(hoa_3d_optim_class);
	if (x)
	{		
...
void hoa_3d_optim_dsp64(t_hoa_3d_optim *x, t_object *dsp64, short *count, double samplerate, long maxvectorsize, long flags)
{
    object_method(dsp64, gensym("dsp_add64"), x, hoa_3d_optim_perform64, 0, NULL);
}
