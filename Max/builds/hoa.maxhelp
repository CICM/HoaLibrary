...
,
									"patching_rect" : [ 248.0, 75.0, 51.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 248.0, 105.0, 99.0, 19.0 ],
									"saved_object_attributes" : 									{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"order" : 7,
									"patching_rect" : [ 311.333374, 372.0, 290.25, 290.25 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 383.0, 328.0, 51.0, 17.0 ],
									"text" : "connect"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 467.0, 270.0, 150.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"order" : 7,
									"patching_rect" : [ 22.000008, 372.0, 290.25, 290.25 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 372.333374, 206.0, 95.0, 32.0 ],
									"text" : "Fractional order\n(0 - 1)"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 372.333374, 246.0, 50.0, 19.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 372.333374, 279.0, 70.0, 19.0 ],
									"text" : "pack 0. 100"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 347.333374, 298.0, 36.0, 20.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 15,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
									"patching_rect" : [ 22.000004, 326.0, 290.25, 19.0 ],
									"saved_object_attributes" : 									{
										"autoconnect" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 15,
									"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
									"patching_rect" : [ 22.0, 230.0, 272.166687, 19.0 ],
									"text" : "hoa.encoder~ 7"
								}
