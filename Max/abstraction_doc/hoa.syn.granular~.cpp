...
/**
 @file      hoa.syn.granular~.cpp
 @name      hoa.syn.granular~
 @realname  hoa.syn.granular~
 @type      abstraction
 @module    hoa
 ...
 @description
 <o>hoa.syn.granular~</o> create a diffuse sound field. It uses delay lines and amplitude modulation to create streams of grains.
