...
/**
 @file      hoa.fx.granular~.cpp
 @name      hoa.fx.granular~
 @realname  hoa.fx.granular~
 @type      abstraction
 @module    hoa
 ...
 @description
 <o>hoa.fx.granular~</o> create a diffuse sound field. It uses delay lines and amplitude modulation to create streams of grains.
 ...
 @seealso hoa.process~, hoa.syn.granular~, hoa.fx.grain~, hoa.fx.decorrelation~, hoa.fx.gain~, hoa.fx.mirror~, hoa.fx.mixer~, hoa.fx.ringmod~
 */
