...
The method returns the argument of an harmonic if it exists, generate an error otherwise. 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The method returns the band of an harmonic if it exists, generate an error otherwise. 
\end{DoxyReturn}
\begin{DoxySeeAlso}{See Also}
