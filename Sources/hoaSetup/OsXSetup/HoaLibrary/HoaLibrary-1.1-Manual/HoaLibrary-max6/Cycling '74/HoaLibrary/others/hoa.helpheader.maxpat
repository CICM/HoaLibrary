...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"pic" : "C:/Users/Pierre/Downloads/hoa-icon-45.png"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.4375, 367.0, 168.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 8.4375, 268.0, 241.0, 48.0 ],
					"text" : "patcherargs @obj-name hoa.library @obj-desc \"A high order ambisonics library\" @width 480"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 239.9375, 323.5, 17.9375, 323.5 ],
					"source" : [ "obj-7", 1 ]
				}
