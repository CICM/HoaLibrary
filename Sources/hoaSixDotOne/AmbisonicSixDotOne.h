...
#ifndef DEF_AMBISONICSIXDOTONE
#define DEF_AMBISONICSIXDOTONE
...
public:
	AmbisonicSixDotOne(long anOrder,  double aFrontDelta = 30., double aSurroundDelta = 110., long aVectorSize = 0);
	...
	{	
		...
		aOutputs[6] /= 6.;
		aOutputs[6] *= 0.017096;
		aOutputs[6] -= m_last_sample;
		m_last_sample = -0.982904 * aOutputs[6];
	}	
	...
	{	
		for(int i = 0; i < m_vector_size; i++)
		{
			...
			aOutputs[6][i] /= 6.;
			aOutputs[6][i] *= 0.017096;
			aOutputs[6][i] -= m_last_sample;
			m_last_sample = -0.982904 * aOutputs[6][i];
		}	
	}	
};
