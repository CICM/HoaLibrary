...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 285.0, 267.0, 33.0 ],
					"presentation_rect" : [ 372.0, 278.0, 0.0, 0.0 ],
					"text" : "warning : in \"out\" mode the first arg don't represent the order but the numer of inlet/outlet",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 573.0, 132.199997, 98.0, 22.0 ],
					"text" : "loadmess 250"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 467.0, 132.199997, 98.0, 22.0 ],
					"text" : "loadmess 220"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.4375, 132.199997, 98.0, 22.0 ],
					"text" : "loadmess 170"
				}
...
,
					"patching_rect" : [ 467.0, 197.0, 56.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 467.0, 171.399994, 92.0, 15.0 ],
					"size" : 256.0
				}
...
,
					"patching_rect" : [ 362.0, 197.0, 56.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 14.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 362.0, 171.399994, 92.0, 15.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 122.9375, 387.75, 157.0, 48.0 ],
					"presentation_rect" : [ 157.9375, 387.5, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.9375, 333.5, 157.0, 48.0 ],
					"presentation_rect" : [ 266.9375, 323.5, 0.0, 0.0 ]
				}
...
,
					"patching_rect" : [ 257.0, 197.0, 56.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 14.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 238.9375, 262.0, 68.0, 22.0 ],
					"presentation_rect" : [ 266.9375, 260.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.9375, 439.5, 157.0, 48.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 312.0, 262.0, 26.0, 21.0 ],
					"text" : "Hz",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 257.0, 132.199997, 104.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 21.9375, 124.0, 225.0, 95.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 257.0, 171.399994, 92.0, 15.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 410.4375, 98.0, 54.0, 16.0 ],
					"text" : "onepole~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 138.9375, 262.0, 68.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 36.4375, 262.0, 68.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.9375, 296.0, 221.0, 22.0 ],
					"text" : "hoa.plug~ 3 hoa.highpass~ out 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 554.5, 415.5, 91.0, 22.0 ],
					"text" : "turn dac~ on",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 502.0, 393.5, 44.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 496.0, 382.75, 149.5, 62.75 ],
					"rounded" : 15,
					"shadow" : -1
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "hoa.highpass~", "@obj-desc", "hoa.plug~", "version", "of", "a", "onepole~", "based", "highpass", "filter" ],
					"id" : "obj-41",
					"maxclass" : "bpatcher",
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 31.4375, 257.0, 233.4375, 257.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 31.4375, 257.0, 132.4375, 257.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 266.5, 231.0, 45.9375, 231.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 371.5, 240.0, 148.4375, 240.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 476.5, 249.0, 248.4375, 249.0 ],
					"source" : [ "obj-34", 0 ]
				}
